...
const ItemCard = ({ detail, version, }: { detail: ItemDetail; version: string; }) => {
  return (
    <Link
      href={`/items/${detail.name}`}
      className="relative flex flex-col items-center justify-center p-4 border border-white bg-black w-[180px] h-[200px] rounded-md group cursor-pointer"
    >
      <Image
      ...
      <span className="text-gray-400 w-full text-center line-clamp-2">{detail.plaintext}</span>
